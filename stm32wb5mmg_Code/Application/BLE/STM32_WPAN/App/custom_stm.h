...
{
  /* AUDIO_STREAM */
  CUSTOM_STM_AUDSTREAM_CHAR,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* audStream_Char */
  CUSTOM_STM_AUDSTREAM_CHAR_READ_EVT,
  CUSTOM_STM_AUDSTREAM_CHAR_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_AUDSTREAM_CHAR_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint8_t SizeAudstream_Char;
