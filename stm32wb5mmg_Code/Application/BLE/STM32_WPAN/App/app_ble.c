...
/* Private variables ---------------------------------------------------------*/
PLACE_IN_SECTION("MB_MEM1")
ALIGN(4) static TL_CmdPacket_t BleCmdBuffer;
...
uint8_t a_AdvData[9] =
    {
        8, AD_TYPE_COMPLETE_LOCAL_NAME, 'E', '-', 'S', 't', 'e', 't', 'h', /* Complete name */

};

/* USER CODE BEGIN PV */
uint8_t bleIndicationCntFlag = 0;
/* USER CODE END PV */
...
void APP_BLE_Init(void)
{
  ...
  bleIndicationCntFlag = 1; // ble connection led flag - starts to blink led for every 500ms while starting.
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
  {
    ...
    if (BleApplicationContext.Device_Connection_Status == APP_BLE_IDLE) // Ble disconnection led indication - blinks led for evry 500ms.
    {
      bleIndicationCntFlag = 1;
    }
  ...
  case HCI_LE_META_EVT_CODE:
  {
    ...
    case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
    {
      ...
      {
        bleIndicationCntFlag = 0; // ble connection led indication - led on
...
static void Ble_Hci_Gap_Gatt_Init(void)
{
  ...
  //                               ALL_PHYS_PREFERENCE/*CFG_ALL_PHYS*/,
  //                               TX_2M/*CFG_TX_PHY*/,
  //                               RX_2M/*CFG_RX_PHY*/,
  //                               0);
  if (ret != BLE_STATUS_SUCCESS)
...
static void Connection_Interval_Update_Req(void)
{
  if (BleApplicationContext.Device_Connection_Status != APP_BLE_LP_ADV && BleApplicationContext.Device_Connection_Status != APP_BLE_IDLE)
  {
